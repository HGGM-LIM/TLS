...
int main( int argc, char *argv[] )
{
  ...
  typedef  itk::FastMarchingRestartableImageFilter< InternalImageType, InternalImageType >    FastMarchingFilterType;
...
//  writer->SetInput( fastMarching->GetOutput() );
  ...
  //Test new methods
  fastMarching->GetAlivePoints();
  fastMarching->GetTrialPoints();
  fastMarching->GetLabelImage();
  fastMarching->SetRestarted(0);
  fastMarching->GetRestarted();
  fastMarching->GetProcessedPoints();
