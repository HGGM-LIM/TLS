...
public:
  ...
  std::vector< itk::Point< double, LevelSetTypeDefault<TLevelSet>::SetDimension > > GetTrials();
  std::vector< itk::Point< double, LevelSetTypeDefault<TLevelSet>::SetDimension > > GetAlives();
...
protected:
  ...
  void GenerateData();
  void RestartPropagation( LevelSetImageType * );
...
#include "itkFastMarchingRestartableImageFilter.txx"
#endif
