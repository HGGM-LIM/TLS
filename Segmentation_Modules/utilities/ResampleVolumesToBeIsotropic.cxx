...
//  intensityWindowing->SetOutputMaximum( itk::NumericTraits<InputPixelType>::max() ); // floats but in the range of chars.
//
...
//  smootherX->SetInput( intensityWindowing->GetOutput() );
  smootherX->SetInput( cast->GetOutput() );
...
// Software Guide : EndCodeSnippet
  ...
  resampler->SetDefaultPixelValue( -1024 ); // highlight regions without source
...
//  resampler->SetInput( smootherY->GetOutput() );
  resampler->SetInput( cast->GetOutput() );
