...
#ifndef MEASURE_ODB_HXX
#define MEASURE_ODB_HXX
...
namespace odb
{
  ...
  //
  template <>
  class access::object_traits< ::Measure >
  {
    public:
    typedef ::Measure object_type;
    typedef ::Measure* pointer_type;
    ...
    static const std::size_t in_column_count = 2UL;
    static const std::size_t out_column_count = 2UL;
