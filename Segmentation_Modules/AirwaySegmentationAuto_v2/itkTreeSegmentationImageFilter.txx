...
segmentImage, PotentialImagePointer potentialImage, float timeStep)
{
  ...
  // this loop is only required with some compilers
  ...
  std::cout << "Going to compute threshold" << std::endl;
...
::EvaluateSegmentAndPossiblyAddToTree(SegmentPointerType segment, OutputImagePointer outputImage, OutputImagePointer segmentImage)
{
  ...
  /*if(growthRate>1.05 &&segment->GetPoints().size()>2000&&m_AirwayNumber>2 )
    {
    std::cout <<"Segment " << m_AirwayNumber << " has "<< "GR: " << growthRate << std::endl;
    std::cout <<"Size is: " << segment->GetPoints().size() << std::endl;
    int loko;
    std::cin >> loko;
    }*/
...
::GenerateData()
{
  ...
  std::cout << "Starting normal propagation" << std::endl;
