/*=========================================================================
  ...
  Module:    $RCSfile: itkHessian3DToAirwaynessMeasureImageFilter.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkHessian3DToAirwaynessMeasureImageFilter_h
#define __itkHessian3DToAirwaynessMeasureImageFilter_h
...
namespace itk
{
/** \class Hessian3DToAirwaynessMeasureImageFilter
 * \brief 
 * Line filter to provide a airwayness measure for tubular objects from the
 ...
 * large positive values. (for dark tubular structures).
 * 
 ...
 *  
 * This filter is used to discriminate the Dark tubular structures.
 *
 * \par References: 
...
class ITK_EXPORT Hessian3DToAirwaynessMeasureImageFilter : public
ImageToImageFilter< Image< SymmetricSecondRankTensor< double, 3 >, 3 >, 
                                                  Image< TPixel, 3 > >
{
public:
  /** Standard class typedefs. */
  typedef Hessian3DToAirwaynessMeasureImageFilter Self;
...
itkStaticConstMacro(ImageDimension,unsigned int,InputImageType::ImageDimension);
  ...
  itkTypeMacro( Hessian3DToAirwaynessMeasureImageFilter, ImageToImageFilter );
...
private:
  Hessian3DToAirwaynessMeasureImageFilter(const Self&); //purposely not implemented
...
#include "itkHessian3DToAirwaynessMeasureImageFilter.txx"
#endif
